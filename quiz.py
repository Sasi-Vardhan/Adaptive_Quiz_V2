...
def load_questions(lesson):
    paths=["Questions/Sustainability_Questions.csv","Questions/generative_ai_questions.csv","Questions/Civil_Engineering_MCQs.csv",
           "Questions/mechanical_engineering_questions.csv","Questions/biomedical_engineering_mcqs.csv","Questions/chemical_engineering_mcqs.csv",
           "Questions/eee_mcqs.csv","Questions/mba_mcqs.csv"
           ]
    questions = []
    try:
        if not lesson:
        ...
        if(session["choice"] == 'sustainability'):
            path=paths[0]
        elif (session["choice"] == 'genai') :
            path=paths[1]
        elif (session["choice"] == 'Civil Engineering') :
            path=paths[2]
        elif (session["choice"] == 'Mechanical Engineering') :
            path=paths[3]
        
        elif (session['choice'] == 'Bioengineering'):
            path=paths[4]
        elif (session['choice'] == 'Chemical Engineering'):
            path=paths[5]
        elif (session['choice'] == 'eee'):
            path=paths[6]
        elif (session['choice'] == 'mba'):
            path=paths[7]
